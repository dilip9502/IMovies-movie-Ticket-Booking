  ...
  return (
    <div className="min-h-screen bg-blue-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-blue-100 mb-2">Select Cinema</h1>
        ...
        <div className="bg-blue-900 rounded-lg shadow-sm p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4 text-blue-100">Select Date</h2>
              ...
              <button
                ...
                className={`flex-shrink-0 px-4 py-3 rounded-lg border font-medium transition-colors ${
                  selectedDate === date.value
                    ...
                    : 'bg-blue-950 text-blue-300 border-blue-800 hover:border-blue-500'
                }`}
              >
                {date.label}
              </button>
        ...
        <div className="space-y-6">
          {cinemas.length > 0 ? (
            cinemas.map((cinema) => (
              <div key={cinema.id} className="bg-blue-900 rounded-lg shadow-sm overflow-hidden">
                <div className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-blue-300 text-sm mb-2">{cinema.address}</p>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {cinema.amenities.map((amenity, index) => (
                          <div
                            key={index}
                            className="flex items-center space-x-1 bg-blue-800 px-2 py-1 rounded-lg text-xs text-blue-300"
                          >
                    ...
                    <div className="lg:ml-8 mt-4 lg:mt-0">
                      <h4 className="font-semibold mb-3 text-blue-100">Show Times</h4>
                      <div className="grid grid-cols-2 lg:grid-cols-1 gap-2">
                        {cinema.showtimes.map((time, index) => (
                          <button
                            key={index}
                            onClick={() => handleShowtimeClick(cinema.id, time)}
                            className="bg-blue-700 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center font-medium transition-colors border border-blue-600"
                          >
