  ...
  return (
    <div className="min-h-screen bg-blue-950 text-blue-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-900 rounded-lg shadow-xl overflow-hidden mb-8 border border-blue-800">
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-700 to-blue-800 text-white p-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h2 className="text-2xl font-bold mb-2">Movie Title</h2>
                <p className="text-blue-200">Cinema Name - Screen 1</p>
              </div>
          ...
          <div className="p-6">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-300">Cinema</p>
                    <p className="font-semibold">Cinema Name</p>
                    <p className="text-sm text-blue-400">City, Location</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-300">Seats</p>
              ...
              <div className="space-y-4">
                <div className="bg-blue-800 p-4 rounded-lg border border-blue-700">
                  <h3 className="font-semibold mb-3 text-white">Payment Summary</h3>
                  <div className="space-y-2 text-sm text-blue-300">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        ₹
                        {Math.round(
                          (bookingData.total + Math.round(bookingData.total * 0.02)) * 0.18
                        )}
                      </span>
                    </div>
                    <div className="border-t pt-2 flex justify-between font-semibold text-white">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>
                          {bookingData.total +
                            Math.round(bookingData.total * 0.02) +
                            Math.round((bookingData.total + Math.round(bookingData.total * 0.02)) * 0.18)}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-blue-800 p-4 rounded-lg border border-blue-700">
                  <h4 className="font-semibold text-blue-100 mb-2">Payment Details</h4>
                  <p className="text-sm text-blue-300">Payment ID: {bookingData.paymentId}</p>
                  <p className="text-sm text-blue-300 capitalize">
                    Method: {bookingData.paymentMethod}
                  </p>
                  <p className="text-sm text-blue-300">Status: Paid</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex items-center justify-center space-x-2 bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-800 transition-colors"
              >
              ...
              <Link
                to="/dashboard"
                className="flex items-center justify-center space-x-2 border border-blue-700 text-blue-300 px-6 py-3 rounded-lg font-semibold hover:bg-blue-800 transition-colors"
              >
        ...
        <div className="bg-blue-800 border border-blue-700 rounded-lg p-6 mb-8 text-blue-300">
          <h3 className="font-semibold text-blue-100 mb-3">Important Information</h3>
