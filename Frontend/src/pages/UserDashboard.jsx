    ...
    <div className="min-h-screen bg-blue-950 text-blue-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-blue-300">Manage your bookings and account settings</p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              {upcomingBookings.length > 0 ? (
                ...
                <div className="bg-blue-900 rounded-lg shadow-sm p-12 text-center">
            ...
            <section>
              ...
              {pastBookings.length > 0 ? (
                ...
                <div className="bg-blue-900 rounded-lg shadow-sm p-8 text-center text-blue-400">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  value={user.name}
                  className="mt-1 w-full px-3 py-2 border border-blue-700 rounded-lg focus:ring-2 focus:ring-blue-600 bg-blue-800 text-blue-100"
                  readOnly
                />
              </div>
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-blue-300">Phone</label>
                <input
                  type="tel"
                  value={user.phone}
                  className="mt-1 w-full px-3 py-2 border border-blue-700 rounded-lg focus:ring-2 focus:ring-blue-600 bg-blue-800 text-blue-100"
        ...
        {activeTab === 'preferences' && (
          <div className="bg-blue-900 rounded-lg shadow-sm p-6">
            <h2 className="text-2xl font-semibold mb-6 text-white">Preferences</h2>
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold mb-3 text-white">Notification Settings</h3>
              ...
              <div>
                <h3 className="font-semibold mb-3 text-white">Preferred Languages</h3>
                <div className="space-y-2 text-blue-300">
                  <label className="flex items-center">
                    <input type="checkbox" className="rounded mr-2" defaultChecked />
                    Telugu
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {isPast && (
                <button
                  ...
                  className="flex items-center space-x-2 border border-blue-600 text-blue-200 px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                >
